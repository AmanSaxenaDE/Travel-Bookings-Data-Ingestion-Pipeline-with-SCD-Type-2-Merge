from pyspark.sql.functions import col, lit, current_timestamp, sum as _sum, expr
...
booking_data = f"/Volumes/workspace/default/travel-booking/booking_data/bookings_{date_str}.csv"
customer_data = f"/Volumes/workspace/default/travel-booking/customer_data/customers_{date_str}.csv"
print(booking_data)
print(customer_data)
...
fact_table_path = "workspace.default.booking_fact"
...
scd_table_path = "workspace.default.customer_dim"
...
if scd_table_exists:
    ...
    scd_table.alias("scd") \
        ...
        .whenMatchedUpdate(
            condition=expr(data_changed_condition),
            set={
